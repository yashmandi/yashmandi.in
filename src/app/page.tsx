    ...
    <main className="min-h-screen flex items-center justify-center px-6 py-12 bg-gray-50">
      <div className="max-w-3xl mx-auto space-y-4 text-slate-800">
        ...
        <div className="space-x-3 flex mb-7">
          <a href="/bookshelf" className="underline font-medium text-blue-800 hover:no-underline">bookshelf</a>
          <a href="/thinkings" className="underline font-medium text-blue-800 hover:no-underline">thinkings</a>
          <a href="https://x.com/yashmandi" target="_blank" className="underline font-medium  text-blue-800 hover:no-underline">x (twitter)</a>
          <a href="https://github.com/yashmandi" target="_blank" className="underline  font-medium text-blue-800 hover:no-underline">github</a>
          <a href="https://linkedin.com/in/yashmandi" target="_blank" className="underline  font-medium text-blue-800 hover:no-underline">linkedin</a>
        ...
        <p>
          currently, i serve as the CTO & founding engineer at <a href="https://www.oneclarity.ai" target="_blank" className="underline text-blue-800 font-medium hover:no-underline">OneClarity</a>, an AI-based B2B productivity platform for enterprises.
        </p>
        ...
        <section>
          ...
          <ul className="list-disc list-inside">
            ...
            <li>i'm a reluctant user of social media and currently only use <a href="https://x.com/yashmandi" target="_blank" className="underline text-blue-800 font-medium hover:no-underline">twitter</a> (sometimes).</li>
          </ul>
        </section>
        ...
        <p>
          ...
          <a href="mailto:yash.mandi@oneclarity.ai" className="underline font-medium text-blue-800 hover:no-underline">e-mail</a>
        </p>
      </div>
    </main>
  );
